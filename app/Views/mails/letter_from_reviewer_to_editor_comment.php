                ...
                <table class="fallback-text" width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td colspan="5" style="padding: 0px" bgcolor="#ffffff">
                            <img src="https://cminds.in/SCRIPTURE/Emailer/13-04-2024-Emailer-2/images/banner.jpg"
                        ...
                        <td colspan="5" style="padding:30px 40px 40px;" bgcolor="#ffffff">
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <p>Dear Editor,</p>
                                        <p>I hope this letter finds you well. I have recently reviewed the manuscript
                                            ...
                                            find the manuscript to be of high quality and merit, with several valuable
                                            contributions to the field.</p>
                                        <p>However, I do have some suggestions for revisions that, in my opinion, would
                                            further enhance the clarity, rigor, and impact of the manuscript. These
                                            suggestions are outlined below:</p>
                                        ...
                                        <?php endif; ?>
                                        <p>I believe that addressing these points would strengthen the manuscript and
                                            improve its overall quality. </p>
                                        <p>Thank you for considering my feedback. I remain committed to assisting in the
                                            improvement of this manuscript and contributing to the rigorous standards of
                                            scholarship upheld by Journal Name .</p>
                                        <p>Please let me know if you require any further clarification or information
                                            regarding my comments.</p>

                                        <p style="margin-top: 28px;">Warm regards,</p>
                                        <p style="margin-top: -6px"><span style="color:#000000;">
                                                <?= $peerName; ?>
                                            </span>
                                        </p>
                                    </td>

                            ...
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0" style="font-family: system-ui;color: #000221; max-width:650px;font-size: 14.3px;padding:0 15px;font-weight:500" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <p>We hope this email finds you well. We wanted to thank you for submitting your article titled "<?= $sub_title; ?>" to [<?= $journal; ?>]. We appreciate the effort you've put into your work.</p>
                                        <p>After a thorough review, we've identified a few areas that require some updates before we can proceed with the publication process. These updates are necessary to ensure the accuracy and quality of the content. Below are the specific points that need attention:</p>
                                        ...
                                        <p>We understand that revising your article may take some time, but please know that addressing these points will greatly enhance the value of your contribution. We kindly request that you make the necessary revisions and resubmit the updated version on our portal at your earliest convenience.</p>
                                        <p>If you have any questions or need clarification on any of the points mentioned, please don't hesitate to reach out. We're here to assist you throughout this process.</p>
                                        <p>Thank you for your cooperation and understanding. We look forward to receiving the revised version of your article.</p>

                            ...
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0" style="font-family: system-ui;color: #000221; max-width:650px;font-size: 14.3px;padding:0 15px;font-weight:500" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <p><b><?= $date; ?></b></p>
                                        <p>Dear <?= $fullName; ?>,</p>
                                        <p>We hope this email finds you well. You have received an update from [<?= $primaryContact; ?>] for the manuscript titled "[Manuscript <?= $title; ?>]" to [Journal <?= $journal; ?>]</p>
                                        <p>Below are the details of the submission:</p>
                                        <p>Subject: <?= $sbjtitle; ?></p>
                                        <p>Message: <?= $message; ?></p>
                                        <?php if (isset($link)) : ?>

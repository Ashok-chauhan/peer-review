                            ...
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0" style="font-family: system-ui;color: #000221; max-width:650px;font-size: 14.3px;padding:0 15px;font-weight:500" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <p><b>Dear Editor,</b></p>
                                        <p>We hope this email finds you well. You have received a new submission of the manuscript titled "<?= $title; ?>" to "<?= $journal; ?>" on <?= date("l jS \of F Y h:i:s A"); ?>.</p>
                                        <p><b>Below are the details of the submission:</b></p>

                                        <p><b>Manuscript Title:: </b><?= $title; ?></p>
                                        <p><b>Corresponding Author: </b><?= $primary_contact; ?></p>
                                        <p><b>Co-Authors: </b><?= $coauthors; ?></p>
                                        <p><b>Journal Name:</b><?= $journal; ?></p>
                                        <p><b>Submission Date: </b><?= date("l jS \of F Y h:i:s A"); ?></p>
                                        <p><b>Manuscript ID: </b><?= $id; ?></p>
                                        <?php if (isset($link)) : ?>
                                            <p>Attachement: <?= $link; ?></p>
                                        <?php endif; ?>


                                        <p>Please feel free to contact us should you require any further information or clarification regarding the submission. </p>

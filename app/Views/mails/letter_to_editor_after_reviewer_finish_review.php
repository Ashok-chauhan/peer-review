                ...
                <table class="fallback-text" width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td colspan="5" style="padding: 0px" bgcolor="#ffffff">
                            <img src="https://cminds.in/SCRIPTURE/Emailer/13-04-2024-Emailer-4/images/banner.jpg"
                        ...
                        <td colspan="5" style="padding:30px 40px 40px;" bgcolor="#ffffff">
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <p>Dear Editor,</p>
                                        <p>I hope this message finds you well. I am writing to inform you that I have
                                            completed the review process for the manuscript titled "<span
                                                style="color:#000000;">
                                                <?= $title; ?>
                                            </span>" submitted to
                                        ...
                                        <p>Overall, I have carefully evaluated the manuscript and provided my feedback
                                            to the authors. I believe that the manuscript holds promise and makes a
                                            valuable contribution to the field. </p>

                                        <p>Please let me know if you require any further information or clarification
                                            regarding my review. I am available to discuss any aspect of the manuscript
                                            or my feedback in more detail if needed.</p>
                                        <p>Thank you for the opportunity to contribute to the peer-review process for
                                            <span style="color:#000000;">
                                                <?= $journal; ?>
                                            </span>. I look forward to
                                            hearing from you regarding the next steps for this manuscript.
                                        </p>

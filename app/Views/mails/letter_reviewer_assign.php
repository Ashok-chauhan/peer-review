                ...
                <table class="fallback-text" width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td colspan="5" style="padding: 0px" bgcolor="#ffffff">
                            <img src="https://cminds.in/SCRIPTURE/Emailer/13-04-2024-Emailer-1/images/banner.jpg"
                            ...
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <p>I hope this letter finds you well. I am writing to request your esteemed
                                            expertise in reviewing a manuscript <span style="color:#000000;">
                                                <?= $submissionTitle; ?>
                                            </span> that has been submitted to <span style="color:#000000;">
                                                <?= $journal; ?>
                                            </span> for publication
                                            consideration.</p>
                                        <p>Title: <span style="color:#000000;">
                                                <?= $title; ?>
                                            </span></p>
                                        <p>Message: <span style="color:#000000;">
                                                <?= $body; ?>
                                            </span>
                                        </p>
                                        <p>We believe that your experience and insights would provide valuable feedback
                                            on the content and methodology presented in the manuscript</p>
                                        <p>As a respected member of the fraternity, your review will greatly contribute
                                            to maintaining the high quality and integrity of our publication. We aim to
                                            ensure that all published articles meet rigorous standards of scientific
                                            excellence, and your thorough evaluation is crucial in achieving this goal.
                                        </p>
                                        <p>Your review is expected to be completed before <span style="color:#000000;">
                                                <?= $date; ?>
                                            </span>. Your comments and
                                            suggestions can be submitted via the online submission system.</p>
                                        <p><a clicktracking=off href="<?= $host; ?>" target="_blank"> <button
                                                    type="button" class="btn btn-primary btn-md"
                                                    style="border-radius:1px;background:#1a4097;padding: 9px 9px;border: 2px solid #1a4097;"><b
                                                        style="color: #ffffff; text-decoration: none;font-size: 15px;">CLICK
                                                        HERE TO REVIEW</b> </button> </a></p>
                                        <p>If you have any questions or need further information, please do not hesitate
                                            to contact me at <a href="mailto:support@scripturesubmission.com"
                                                target="_blank">support@scripturesubmission.com</a></p>
                                        <p>Thank you in advance for your time and expertise in assisting us with the
                                            review process. We sincerely appreciate your dedication to advancing
                                            scientific knowledge in our field.</p>

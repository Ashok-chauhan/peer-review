            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input name="password" value="<?= set_value('password'); ?>" id="password" class="form-control" placeholder="Password" type="password" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-0 row mt-2">
                            <div class="col-sm-5 mt-3">
                                ...
                                <a href="<?= base_url(); ?>user/resetpass" class="text-muted"><i class="mdi mdi-account-circle"></i> Forgot password</a>

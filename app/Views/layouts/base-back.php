...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/registration.css" />
...
<body class="container-fluid">
  ...
  <header>
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              <?php elseif (session()->get('role') == 2) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>editor">Home</a>
              <?php elseif (session()->get('role') == 3) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>author/profile">Home</a>
              <?php elseif (session()->get('role') == 4) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>peer">Home</a>
              <?php elseif (session()->get('role') == 5) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>translator">Home</a>
              <?php elseif (session()->get('role') == 6) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>reader">Home</a>
              <?php elseif (session()->get('role') == 7) : ?>
                <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>editcopy">Home</a>
              <?php endif; ?>
            </li>

            <?php if (session()->get('logged_user')) : ?>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>author/logout">Logout</a>
              </li>
            <?php else : ?>
              <li class="nav-item">
    ...
    <h1>Welcome to peer review system</h1>

    <h2>The robust review with powerful features</h2>
  ...
  <footer>
    ...
    <p class="col-6 offset-5">©Copyright 2023 All rights reversed.</p>
  </footer>
</body>

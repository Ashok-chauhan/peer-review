                    ...
                    <form action="sendtopeer" method="POST">
                        <div class="row">
                            <div class="list-group col-12">
                                ...
                                <p></p>
                                <div>
                                    <label for="completion_date" class="form-label fw-bold ">FINISH REVIEW BEFORE<span> *</span></label>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="square-switch">
                                                            <input type="checkbox" id="contentid<?= $k; ?>" switch="info" name="contentid[]" value="<?= $content->id; ?>" />

                                                            <label for="contentid<?= $k; ?>" data-on-label="Yes" data-off-label="No"></label>

                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php elseif ($row->status == 10): ?>
                                                                <span class="btn-danger  waves-light"
                                                                    ...
                                                                    <i class="fas fa-edit"></i>&nbsp; Under Production
                                                                </span>
                                                            ...
                                                            <?php elseif ($row->status >= 10 && $row->status < 20): ?>
                                                        ...
                                                        <td width="5%">
                                                            <?php if ($row->status < 11): ?>
                                                                <?= anchor('production/accept/' . $row->submissionID . '/' . $row->id, '<span class="btn1 btn-success"><i class="fa fa-eye"></i></span>'); ?>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>

            ...
            <div class="card">
                <div class="card-body ">
                    ...
                    <div class="">
                        ...
                        <!--                         
                        <div class="list-group-item" role="alert">
                            <button type="button" class="btn btn-dark waves-effect waves-light" style="padding: 0.47rem 46px;">
                            ...
                            <?php foreach ($discussions as $key => $discussion) : ?>
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="font-size-14 my-1"><?php
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#replyModal" data-arridx="<?= $discussion->sender_id . '/' . $discussion->sender_email . '/' . $discussion->submissionID . '/' . $discussion->title; ?>">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="replyForm" action="../reply" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="subject-title" name="subject-title" value="" required>

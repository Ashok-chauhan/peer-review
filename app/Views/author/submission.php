...
<!-- tinymce bof -->
<!-- api key -->
<!-- roalqr6zp2z7qh1eo3y82dq9p4xe7ximw89bcl8bqs5l158i -->
                ...
                <div id="basic-pills-wizard" class="twitter-bs-wizard">
                    <div class="twitter-bs-wizard-tab-content">
                        <div class="tab-pane" id="seller-details">
                            ...
                            <h4 class="card-title font-size-13" style="margin-bottom:16px">You must read and acknowledge
                                that you've completed the requirements below before proceeding.</h4>
                            <div class="form-group mb-3 row ">
                                <div class="col-12">

                                    <div class="custom-control custom-checkbox ">
                                        <label class="form-label  fw-normal" for="terms1">
                                            <input type="checkbox" class="custom-control-input terms" id="terms1"
                                                name="terms1"> <a href="#" class="text-muted2 ms-1">The submission has
                                                not been previously published, nor is it before another journal for
                                                consideration (or an explanation has been provided in Comments to the
                                                Editor). </a></label>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <label class="form-label  fw-normal" for="terms2">
                                            <input type="checkbox" class="custom-control-input terms" id="terms2"
                                                name="terms2"> <a href="#" class="text-muted2 ms-1">The submission file
                                                is in Microsoft Word document file format ONLY.</a></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <label class="form-label  fw-normal" for="terms3">
                                            <input type="checkbox" class="custom-control-input terms" id="terms3"
                                                name="terms3"> <a href="#" class="text-muted2 ms-1">Where available,
                                                URLS for the references have been provided.</a></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <label class="form-label  fw-normal" for="terms4">
                                            <input type="checkbox" class="custom-control-input terms" id="terms4"
                                                name="terms4"> <a href="#" class="text-muted2 ms-1">The text is
                                                single-spaced; uses a 12-point font; employs italics, rather than
                                                underlining (except with URL addresses); and all illustrations, figures,
                                                and tables files should be attached separately.</a></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <label class="form-label  fw-normal" for="terms5">
                                            <input type="checkbox" class="custom-control-input terms" id="terms5"
                                                name="terms5"> <a href="#" class="text-muted2 ms-1">The text adheres to
                                                the stylistic and bibliographic requirements outlined in the Author
                                                Guidelines.</a></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea-tiny name="editor_comment" id="editor_comment" height="300" width="400">
                                </textarea-tiny>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div>
            <!-- First modal dialog -->
            <div class="modal fade" id="contributorModal" data-bs-backdrop="static" data-bs-keyboard="false"
                aria-hidden="true" aria-labelledby="contributorModalLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <form id="contributorForm" name="contributorForm" action="contributor" method="POST"
                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="card-body2">
                                        <div class="tab-pane" id="seller-details">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label font-size-13"
                                                            for="basicpill-address-input">Title</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label font-size-13" for="c-name">First Name
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control" id="m_name"
                                                            name="m_name">
                                                        <label class="form-label font-size-13" for="m_name">Middle
                                                            Name</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label font-size-13" for="l_name">Last Name
                                                            <span style="color:#ff0000">*</span></label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <input type="email" class="form-control" id="c-email"
                                                            name="c-email" required>
                                                        <label class="form-label font-size-13" for="c-email">Email <span
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <select class="form-select" aria-label="Country" id="c-country"
                                                            name="c-country">
                                                        ...
                                                        <label class="form-label font-size-13"
                                                            for="basicpill-address-input">Country <span
                                                                style="color:#ff0000">*</span></label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label font-size-13"
                                                            for="basicpill-address-input">URL</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label font-size-13" for="orcid">ORCHID
                                                            iD</label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control" id="affiliation"
                                                            name="affiliation">
                                                        <label class="form-label font-size-13"
                                                            for="affiliation">Affiliation</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea-tiny class="form-control" aria-label="Statements"
                                                        id="bio_statement" name="bio_statement"
                                                        rows="3"></textarea-tiny>
                                                </div> <!-- end col -->
                                            </div>

                                            <br>
                                            <h4 class="card-title font-size-14"><b>Contributor's Role <span
                                                        style="color:#ff0000">*</span></b></h4>

                                            <div class="form-check">
                                                <input class="form-check-input coauth" type="radio" id="c-roleID"
                                                    name="c-roleID" value="3">
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                    Author
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input coauth" type="radio" id="cc-roleID"
                                                    name="c-roleID" value="5">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="browse_list" name="browse_list" checked>
                            ...
                            <div class="modal-footer">
                                ...
                                <button data-bs-dismiss="modal" class="btn btn-danger waves-effect"
                                    style="float: right;">
                                    Cancel
                                </button>
                                &nbsp; &nbsp; &nbsp;
...
<div class="modal fade" id="authorModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="authorForm" name="authorForm" action="authorTempUpload" method="POST"
                    enctype="multipart/form-data">
                    <div class="mb-3">
...
<!-- Title upload modal  -->
<div class="modal fade" id="titleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
...
<!-- Article upload bof -->
<div class="modal fade" id="articleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"

                    ...
                    <div class="twitter-bs-wizard-tab-content">
                        <div class="tab-pane" id="seller-details">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        <h4 class="card-title font-size-14"><b>Article page *</b></h4>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        <!-- onclick="authReset('articleForm');" -->
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        <h4 class="card-title font-size-14"><b>Article text *</b></h4>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        <!-- onclick="authReset('titleForm');" -->

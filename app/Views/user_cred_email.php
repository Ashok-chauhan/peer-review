                        ...
                        <td colspan="5" style="padding:30px 40px 40px;" bgcolor="#ffffff">
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0" style="font-family: system-ui;color: #000221; max-width:650px;font-size: 14.3px;padding:0 15px;font-weight:500" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <p>Congratulations!</p>
                                        <p><b>Welcome to Scripture!</b></p>
                                        <p>We're thrilled to have you as a member of our community, and we appreciate your trust in us. Your account has been successfully created, and you are now ready to explore the opportunities and benefits our portal offers.</p>
                                        <p>Following is the login details to access your account:</p>
                                        <p>URL: <?= $link; ?></p>
                                        <p>Username: <?= $email; ?></p>
                                        <p>Keep an eye on your email inbox for updates, announcements, and important information from Scripture. We'll also notify you of any new opportunities or events that align with your interests.</p>
                                        <p><b>Need Help?</b></p>
                                        <p>If you have any questions or encounter any issues, our support team is here to assist you. Feel free to reach out to us at <a clicktracking=off href="mailto:support@scripturesubmission.com" target="_blank">support@scripturesubmission.com</a> for prompt and friendly assistance.</p>
                                        <p>Thank you for joining Scripture. We look forward to seeing your contributions and making your experience with us exceptional.</p>

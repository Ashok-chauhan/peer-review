                            ...
                            <table class="fallback-text" width="100%" cellspacing="0" cellpadding="0" style="font-family: system-ui;color: #000221; max-width:650px;font-size: 14.3px;padding:0 15px;font-weight:500" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <p>Dear <?= $title . ' ' . $name . ' ' . $last_name ?>,</p>
                                        <p>Thank you for creating an account with Scripture! To ensure the security of your account and activate its full functionality, we need to verify your email address.</p>
                                        <p><b>Action Required: Verify Your Email Address</b></p>
                                        ...
                                        <p>You must complete the verification process to access all features of Scripture.</p>
                                        <p>If you did not create an account on our portal, please ignore this email.</p>

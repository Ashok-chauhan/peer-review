        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>From <span class="fw-bold">Editorial</span> : <?= $peerMailRecieved->sender . '  ' . $peerMailRecieved->sender_email; ?></div>
                        ...
                        <?php if ($peerMailRecieved->content): ?>
                            ...
                            <p><a href="../../../editor/downloads/<?= $peerMailRecieved->content; ?>"><?= $peerMailRecieved->content; ?> </a> </p>

        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="text-muted text-center font-size-18"><b>SET PASSWORD</b></h4>
                    ...
                    <div class="p-3">
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input name="password" class="form-control" placeholder="Enter new password" type="password" required>
                        ...
                        <div class="form-group mb-3 text-center row mt-3 pt-1">
                            <div class="col-12">
                                <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Set new password</button>
                            </div>
                        </div>
